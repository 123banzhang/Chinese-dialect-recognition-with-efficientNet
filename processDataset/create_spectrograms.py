...
#parser.add_argument("--audio_type", type=str, default="mp3",help="audio type")  C:\Users\Pang Bo\Desktop\大三上\大创\普通话识别  C:/Users/Pang Bo/Desktop/大三下/方言/hebei/train/speaker01



# parser = argparse.ArgumentParser()
# parser.add_argument("--input_dir", type=str, default='C:/Users/Pang Bo/Desktop/大三下/方言/hebei/train/speaker0',help="")
# parser.add_argument("--save_img_dir", type=str, default="C:/Users/Pang Bo/Desktop/大三下/方言/Spoken-language-identification-pytorch/images",help="")
...
def logscale_spec(spec, sr=44100, factor=20., alpha=1.0, f0=0.9, fmax=1):
    ...
    scale = np.array(list(map(lambda x: x * alpha if x <= f0 else (fmax-alpha*f0)/(fmax-f0)*(x-f0)+alpha*f0, scale)))  #add list convert
...
if __name__ == '__main__':
    for i in range(1, 10):
        parser = argparse.ArgumentParser()
        parser.add_argument("--input_dir", type=str, default='C:/Users/Pang Bo/Desktop/大三下/方言/sichuan/train/speaker0',
                            help="")
        parser.add_argument("--save_img_dir", type=str,
                            default="C:/Users/Pang Bo/Desktop/大三下/方言/Spoken-language-identification-pytorch/images",
                            help="")
        parser.add_argument("--audio_type", type=str, default="wav", help="audio type")

        opt = parser.parse_args()
        print(opt);
        opt.input_dir=opt.input_dir+str(i)
        create_spec(input_dir = opt.input_dir,save_img_dir = opt.save_img_dir,audio_type = opt.audio_type)
    for i in range(10, 31):
        parser = argparse.ArgumentParser()
        parser.add_argument("--input_dir", type=str, default='C:/Users/Pang Bo/Desktop/大三下/方言/sichuan/train/speaker',
                            help="")
        parser.add_argument("--save_img_dir", type=str,
                            default="C:/Users/Pang Bo/Desktop/大三下/方言/Spoken-language-identification-pytorch/images",
                            help="")
